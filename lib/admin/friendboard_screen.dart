                ...
                children: [
                  ...
                  isEditing
                    ...
                    onPressed: () {
                      ...
                      FirebaseFirestore.instance.collection("friend Posts").doc(widget.postId).update({
                            ...
                            actions: [
                              ...
                              TextButton(
                                onPressed: () {
                                  ...
                                  FirebaseFirestore.instance.collection("friend Posts").doc(widget.postId).delete();
                                  Navigator.pop(context);
                                },
                                child: Text('삭제'),
                              ),
